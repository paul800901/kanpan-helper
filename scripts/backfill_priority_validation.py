#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""回填 v30 排序驗證、單因子、組合、策略、密度、阻塞、時序、特徵、追蹤、alpha 拆解、長期驗證、失效環境分析與啟用判斷報告。"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="回填 v30 排序驗證層 reports")
    parser.add_argument(
        "--refresh-context",
        action="store_true",
    ...
    print(f"   Strategy Activation: {result['strategy_activation_path']}")
